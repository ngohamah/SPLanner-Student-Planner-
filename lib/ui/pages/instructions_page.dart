        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Tap on the big box "What\'s needs to be done?" given above on the homepage. And just type your task and then press enter.',
                style: bodyText1,
              ),
              ...
              Text(
                'Tap on the circle icon button leading the task name.',
                style: bodyText1,
              ),
              const Divider(height: 16),
              Text(
                'How to permanently delete a task?',
                style: headline6,
              ),
              Text(
                'Just swipe the task from any direction.',
                style: bodyText1,
              ),
              const Divider(height: 16),
              Text(
              ...
              Text(
                'Tap on the pin icon button trailing the task name. It will be pinned to the Pinned tab.',
                style: bodyText1,
              ),
              const Divider(height: 16),
              Text(
              ...
              Text(
                'Just tap on the task title and type whatever you want.',
                style: bodyText1,
              ),
              const Divider(height: 16),
              Text(
                'How to take backup of my tasks?',
                style: headline6,
              ),
              Text(
